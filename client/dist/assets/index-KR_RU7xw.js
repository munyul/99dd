...
`;function dr({name:e,size:t=24}){return(0,A.jsx)(`svg`,{width:t,height:t,viewBox:`0 -960 960 960`,fill:`currentColor`,"aria-hidden":`true`,focusable:`false`,children:(0,A.jsx)(`path`,{d:lr[e]})})}function fr({label:e,icon:t,onClick:n}){return(0,A.jsx)(`button`,{type:`button`,className:`cp-control`,"aria-label":e,onClick:n,children:(0,A.jsx)(dr,{name:t})})}function pr(){return(0,A.jsxs)(`div`,{className:`cp-guide`,"aria-hidden":`true`,children:[(0,A.jsx)(`span`,{className:`cp-corner cp-corner-tl`}),(0,A.jsx)(`span`,{className:`cp-corner cp-corner-tr`}),(0,A.jsx)(`span`,{className:`cp-corner cp-corner-bl`}),(0,A.jsx)(`span`,{className:`cp-corner cp-corner-br`})]})}function mr({onClose:e,onToggleFlash:t,onOpenGallery:n,onCapture:r,onSwitchCamera:i}){let a=O();return(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(`style`,{children:ur}),(0,A.jsx)(Zn,{className:`cp-page`,deviceClassName:`cp-device`,showStatusBar:!1,children:(0,A.jsxs)(`div`,{className:`cp-screen`,children:[(0,A.jsxs)(`div`,{className:`cp-statusbar`,"aria-hidden":`true`,children:[(0,A.jsx)(`span`,{children:`9:41`}),(0,A.jsxs)(`div`,{className:`cp-status-icons`,children:[(0,A.jsx)(dr,{name:`signal`,size:16}),(0,A.jsx)(dr,{name:`wifi`,size:16}),(0,A.jsx)(dr,{name:`battery`,size:16})]})]}),(0,A.jsxs)(`header`,{className:`cp-header`,children:[(0,A.jsx)(`button`,{type:`button`,className:`cp-top-action`,"aria-label":`촬영 화면 닫기`,onClick:()=>{if(e){e();return}a(cr.home)},children:(0,A.jsx)(dr,{name:`close`,size:26})}),(0,A.jsx)(`div`,{className:`cp-title`,role:`heading`,"aria-level":`1`,children:`계약서 촬영`}),(0,A.jsx)(`button`,{type:`button`,className:`cp-top-action`,"aria-label":`플래시 켜기`,onClick:t,children:(0,A.jsx)(dr,{name:`flashOff`,size:26})})]}),(0,A.jsxs)(`main`,{className:`cp-main`,"aria-label":`계약서 촬영`,children:[(0,A.jsx)(pr,{}),(0,A.jsx)(`div`,{className:`cp-hint`,children:`계약서 전체가 잘 보이게 맞춰주세요`})]}),(0,A.jsxs)(`footer`,{className:`cp-footer`,children:[(0,A.jsx)(fr,{label:`앨범에서 계약서 선택`,icon:`image`,onClick:()=>{if(n){n();return}a(cr.upload)}}),(0,A.jsx)(`button`,{type:`button`,className:`cp-shutter`,"aria-label":`계약서 촬영`,onClick:()=>{if(r){r();return}a(cr.ocrProgress)}}),(0,A.jsx)(fr,{label:`카메라 전환`,icon:`cameraSwitch`,onClick:i})]})]})})]})}var hr=[{id:`labor-attorney`,icon:`support_agent`,iconClassName:`expert-option-icon-highlight`,title:`노무사 무료 상담 연결`,description:`공인노무사와 1:1 채팅 상담`},{id:`employment-center`,icon:`phone_in_talk`,title:`고용노동부 상담센터`,description:`국번없이 1350 · 평일 9시~18시`},{id:`complaint-help`,icon:`edit_document`,title:`노동청 진정서 작성 도움`,description:`분석 결과 기반 자동 작성`}],gr=[{id:`fee`,question:`상담료가 있나요?`,answer:`노무사 무료 상담 연결은 무료로 이용할 수 있어요. 상담 내용과 범위에 따라 추가 서비스가 필요한 경우에는 상담 전에 별도로 안내해 드려요.`},{id:`privacy`,question:`상담 내용이 회사에 알려지나요?`,answer:`아니요. 상담 내용은 본인과 상담 전문가만 확인할 수 있으며, 사용자의 동의 없이 회사에 전달되지 않아요.`}];function _r({onLaborAttorneyClick:e,onEmploymentCenterClick:t,onComplaintHelpClick:n}){let[r,i]=(0,x.useState)(null),a={"labor-attorney":e,"employment-center":t,"complaint-help":n};function o(e){i(t=>t===e?null:e)}return(0,A.jsxs)(`div`,{className:`expert-consultation-page`,children:[(0,A.jsx)(`section`,{className:`expert-intro`,"aria-labelledby":`expert-consultation-title`,children:(0,A.jsxs)(`p`,{children:[`혼자 판단하기 어렵다면`,(0,A.jsx)(`br`,{}),`전문가의 도움을 받아보세요`]})}),(0,A.jsx)(`section`,{className:`expert-option-list`,"aria-label":`상담 방법`,children:hr.map(e=>(0,A.jsxs)(`button`,{className:`expert-option-card`,type:`button`,onClick:a[e.id],children:[(0,A.jsx)(`span`,{className:`expert-option-icon ${e.iconClassName??``}`,"aria-hidden":`true`,children:(0,A.jsx)(`span`,{className:`msr`,children:e.icon})}),(0,A.jsxs)(`span`,{className:`expert-option-copy`,children:[(0,A.jsx)(`strong`,{children:e.title}),(0,A.jsx)(`span`,{children:e.description})]}),(0,A.jsx)(`span`,{className:`msr expert-option-arrow`,"aria-hidden":`true`,children:`chevron_right`})]},e.id))}),(0,A.jsxs)(`section`,{className:`expert-faq`,"aria-labelledby":`expert-faq-title`,children:[(0,A.jsx)(`h2`,{id:`expert-faq-title`,children:`자주 묻는 질문`}),(0,A.jsx)(`div`,{className:`expert-faq-list`,children:gr.map(e=>{let t=r===e.id;return(0,A.jsxs)(`article`,{className:`expert-faq-item ${t?`is-open`:``}`,children:[(0,A.jsxs)(`button`,{className:`expert-faq-question`,type:`button`,"aria-expanded":t,"aria-controls":`faq-answer-${e.id}`,onClick:()=>o(e.id),children:[(0,A.jsx)(`span`,{children:e.question}),(0,A.jsx)(`span`,{className:`msr`,"aria-hidden":`true`,children:`expand_more`})]}),t&&(0,A.jsx)(`p`,{id:`faq-answer-${e.id}`,className:`expert-faq-answer`,children:e.answer})]},e.id)})})]})]})}function vr({onLaborAttorneyClick:e,onEmploymentCenterClick:t,onComplaintHelpClick:n}){let r=O();return(0,A.jsxs)(Zn,{children:[(0,A.jsx)(Gn,{title:`전문가 상담`,leftIcon:`arrow_back`,onLeftClick:()=>r(-1)}),(0,A.jsx)(`main`,{className:`content-slot`,children:(0,A.jsx)(_r,{onLaborAttorneyClick:e??(()=>r(`/`)),onEmploymentCenterClick:t??(()=>r(`/`)),onComplaintHelpClick:n??(()=>r(`/`))})})]})}var yr=[{key:`all`,label:`전체`},{key:`danger`,label:`위험`},{key:`caution`,label:`주의`},{key:`safe`,label:`안전`}],br=[{id:1,title:`알바몬 카페 근로계약서`,date:`2026.07.26`,score:32,status:`danger`,issueCount:3},{id:2,title:`편의점 아르바이트 계약서`,date:`2026.07.24`,score:61,status:`caution`,issueCount:1},{id:3,title:`스타트업 인턴 계약서`,date:`2026.07.20`,score:94,status:`safe`,issueCount:0},{id:4,title:`프리랜서 업무 계약서`,date:`2026.07.18`,score:28,status:`danger`,issueCount:2},{id:5,title:`신규 계약서 분석 요청`,date:`2026.07.15`,score:null,status:`pending`,issueCount:0}],xr={danger:{label:`위험`,icon:`description`},caution:{label:`주의`,icon:`description`},safe:{label:`안전`,icon:`description`},pending:{label:`대기`,icon:`hourglass_empty`}};function Sr({item:e}){let{title:t,date:n,score:r,status:i,issueCount:a}=e,o=i===`pending`,s=xr[i];return(0,A.jsx)(rr,{className:`history-card`,children:(0,A.jsxs)(`div`,{className:`row between gap12`,children:[(0,A.jsx)(`div`,{className:`history-icon history-icon-${i}`,children:(0,A.jsx)(`span`,{className:`msr`,children:s.icon})}),(0,A.jsxs)(`div`,{className:`history-body`,children:[(0,A.jsx)(`div`,{className:`f14 fw8 ellipsis`,children:t}),(0,A.jsx)(`div`,{className:`f12 tc mt4`,children:o?`분석 대기중`:`${n} · 위험도 ${r}점`})]}),o?(0,A.jsx)(`span`,{className:`badge badge-gray`,children:`대기`}):(0,A.jsxs)(er,{status:i,children:[s.label,a>0&&` ${a}`]})]})})}function Cr(){let[e,t]=(0,x.useState)(`all`),n=br.filter(t=>e===`all`||t.status===e);return(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(`div`,{className:`row gap8 chip-row`,children:yr.map(({key:n,label:r})=>(0,A.jsx)(`button`,{type:`button`,className:`chip ${e===n?`active`:``}`,onClick:()=>t(n),children:r},n))}),(0,A.jsx)(`div`,{className:`col gap12 mt16`,children:n.map(e=>(0,A.jsx)(Sr,{item:e},e.id))})]})}function wr(){return(0,A.jsxs)(Zn,{children:[(0,A.jsx)(Gn,{title:`분석 내역`}),(0,A.jsx)(`main`,{className:`content-slot`,children:(0,A.jsx)(Cr,{})}),(0,A.jsx)(Yn,{activeTab:`history`})]})}var Tr=[{id:1,type:`analysis-danger`,title:`분석이 완료됐어요`,message:`'알바몬 카페 근로계약서'에서 위험 조항 3건이 발견됐어요`,createdAt:`2026-08-01T09:31:00+09:00`,isRead:!1,target:{tab:`history`,analysisId:1}},{id:2,type:`analysis-complete`,title:`분석이 완료됐어요`,message:`'스타트업 인턴 계약서' 분석이 정상적으로 완료됐어요`,createdAt:`2026-08-01T08:20:00+09:00`,isRead:!0,target:{tab:`history`,analysisId:2}},{id:3,type:`expert-reply`,title:`노무사 답변이 도착했어요`,message:`문의하신 손해배상 조항에 대한 답변을 확인해 보세요`,createdAt:`2026-07-30T14:10:00+09:00`,isRead:!1,target:{tab:`feedback`,consultationId:1}},{id:4,type:`labor-news`,title:`2026년 최저임금 안내`,message:`최저임금 변경 내용과 적용 시점을 확인하세요`,createdAt:`2026-07-27T10:00:00+09:00`,isRead:!0,target:{tab:`labor-news`,noticeId:1}}],Er={"analysis-danger":{icon:`warning`,className:`notification-icon-danger`},"analysis-complete":{icon:`task_alt`,className:`notification-icon-complete`},"expert-reply":{icon:`support_agent`,className:`notification-icon-default`},"labor-news":{icon:`campaign`,className:`notification-icon-default`}},Dr=Er[`labor-news`];function Or(e){let t=Math.floor((Date.now()-new Date(e).getTime())/6e4);if(!Number.isFinite(t)||t<1)return`방금 전`;if(t<60)return`${t}분 전`;let n=Math.floor(t/60);return n<24?`${n}시간 전`:`${Math.floor(n/24)}일 전`}function kr(e,t=new Date){let n=new Date(e);return n.getFullYear()===t.getFullYear()&&n.getMonth()===t.getMonth()&&n.getDate()===t.getDate()}function Ar(e,t=new Date){let n=new Date(e),r=new Date(t),i=r.getDay(),a=i===0?6:i-1;return r.setHours(0,0,0,0),r.setDate(r.getDate()-a),n>=r&&n<=t}function jr({notification:e,onClick:t}){let n=Er[e.type]??Dr;return(0,A.jsxs)(`button`,{className:`alert-notification-item`,type:`button`,onClick:()=>t?.(e.target,e.id),children:[(0,A.jsx)(`span`,{className:`alert-notification-icon ${n.className}`,"aria-hidden":`true`,children:(0,A.jsx)(`span`,{className:`msr`,children:n.icon})}),(0,A.jsxs)(`span`,{className:`alert-notification-content`,children:[(0,A.jsx)(`strong`,{className:`alert-notification-title`,children:e.title}),(0,A.jsx)(`span`,{className:`alert-notification-description`,children:e.message}),(0,A.jsx)(`time`,{className:`alert-notification-time`,dateTime:e.createdAt,children:Or(e.createdAt)})]}),!e.isRead&&(0,A.jsx)(`span`,{className:`unread-dot`,"aria-label":`읽지 않은 알림`})]})}function Mr({title:e,notifications:t,emptyMessage:n,onNotificationClick:r}){return(0,A.jsxs)(`section`,{className:`alert-notification-section`,"aria-labelledby":`${e}-heading`,children:[(0,A.jsx)(`h2`,{id:`${e}-heading`,className:`alert-notification-section-title`,children:e}),t.length>0?(0,A.jsx)(`div`,{className:`alert-notification-items`,children:t.map(e=>(0,A.jsx)(jr,{notification:e,onClick:r},e.id))}):(0,A.jsx)(`p`,{className:`alert-notification-empty`,children:n})]})}function Nr({notifications:e=Tr,onNotificationClick:t}){let n=[...e].sort((e,t)=>new Date(t.createdAt).getTime()-new Date(e.createdAt).getTime()),r=n.filter(e=>kr(e.createdAt)),i=n.filter(e=>!kr(e.createdAt)&&Ar(e.createdAt));return(0,A.jsxs)(`div`,{className:`alert-notification-list`,children:[(0,A.jsx)(Mr,{title:`오늘`,notifications:r,emptyMessage:`오늘 새로 도착한 알림이 없어요`,onNotificationClick:t}),(0,A.jsx)(Mr,{title:`이번 주`,notifications:i,emptyMessage:`이번 주 알림이 없어요`,onNotificationClick:t})]})}function Pr({notifications:e=Tr,onNotificationClick:t}){let n=O();function r(e){if(t){t(e);return}if(e?.tab===`history`){n(Kn.analysisHistory);return}e?.tab===`feedback`&&n(Kn.professionalFeedback)}return(0,A.jsxs)(Zn,{children:[(0,A.jsx)(Gn,{title:`알림`}),(0,A.jsx)(`main`,{className:`content-slot`,children:(0,A.jsx)(Nr,{notifications:e,onNotificationClick:r})}),(0,A.jsx)(Yn,{activeTab:`alarm`})]})}var Fr=20971520,Ir=[`pdf`,`jpg`,`jpeg`,`png`],Lr={home:`/`,ocrProgress:`/screen/9`},Rr=`
  .fu-page,
  .fu-page * {
    box-sizing: border-box;
  }
...
`;function zr(){return(0,A.jsxs)(`svg`,{width:`32`,height:`32`,viewBox:`0 0 32 32`,"aria-hidden":`true`,children:[(0,A.jsx)(`path`,{d:`M8.5 3.75h10.25l4.75 4.75v18.75a1.5 1.5 0 0 1-1.5 1.5H8.5A1.5 1.5 0 0 1 7 27.25v-22a1.5 1.5 0 0 1 1.5-1.5Z`,fill:`none`,stroke:`currentColor`,strokeLinecap:`round`,strokeLinejoin:`round`,strokeWidth:`2.5`}),(0,A.jsx)(`path`,{d:`M18.75 3.75V8.5h4.75M15.25 23V13.25m0 0-4 4m4-4 4 4`,fill:`none`,stroke:`currentColor`,strokeLinecap:`round`,strokeLinejoin:`round`,strokeWidth:`2.5`})]})}function Br(){return(0,A.jsxs)(`svg`,{width:`22`,height:`22`,viewBox:`0 0 24 24`,"aria-hidden":`true`,children:[(0,A.jsx)(`path`,{d:`M6.5 2.75h7l4 4v14.5h-11a1.5 1.5 0 0 1-1.5-1.5V4.25a1.5 1.5 0 0 1 1.5-1.5Z`,fill:`none`,stroke:`currentColor`,strokeLinecap:`round`,strokeLinejoin:`round`,strokeWidth:`1.8`}),(0,A.jsx)(`path`,{d:`M13.5 2.75v4h4`,fill:`none`,stroke:`currentColor`,strokeWidth:`1.8`}),(0,A.jsx)(`rect`,{x:`2.75`,y:`10`,width:`15.5`,height:`7`,rx:`1.5`,fill:`currentColor`}),(0,A.jsx)(`text`,{x:`10.5`,y:`15.15`,fill:`#ffffff`,fontFamily:`Arial, sans-serif`,fontSize:`4.7`,fontWeight:`700`,textAnchor:`middle`,children:`PDF`})]})}function Vr(){return(0,A.jsxs)(`svg`,{width:`22`,height:`22`,viewBox:`0 0 24 24`,"aria-hidden":`true`,children:[(0,A.jsx)(`rect`,{x:`3`,y:`4`,width:`18`,height:`16`,rx:`2`,fill:`none`,stroke:`currentColor`,strokeWidth:`1.8`}),(0,A.jsx)(`circle`,{cx:`8.2`,cy:`9`,r:`1.5`,fill:`currentColor`}),(0,A.jsx)(`path`,{d:`m5.5 17 4.2-4.2 2.8 2.7 2.4-2.2 3.6 3.7`,fill:`none`,stroke:`currentColor`,strokeLinecap:`round`,strokeLinejoin:`round`,strokeWidth:`1.8`})]})}function Hr(){return(0,A.jsx)(`svg`,{width:`24`,height:`24`,viewBox:`0 0 24 24`,"aria-hidden":`true`,children:(0,A.jsx)(`path`,{d:`m6 6 12 12M18 6 6 18`,fill:`none`,stroke:`currentColor`,strokeLinecap:`round`,strokeWidth:`2.2`})})}function Ur(e){return e.split(`.`).pop()?.toLowerCase()??``}function Wr(e){return Ir.includes(Ur(e.name))}function Gr(e){return e<1048576?`${Math.max(e/1024,.1).toFixed(1)}KB`:`${(e/1048576).toFixed(1)}MB`}function Kr({onClose:e,onFileSelect:t,onStartAnalysis:n}){let r=O(),i=(0,x.useRef)(null),a=(0,x.useRef)(0),[o,s]=(0,x.useState)(null),[c,l]=(0,x.useState)(``),[u,d]=(0,x.useState)(!1),f=()=>{i.current?.click()},p=e=>{if(e){if(!Wr(e)){l(`PDF, JPG, PNG 파일만 선택할 수 있어요.`);return}if(e.size>Fr){l(`파일은 최대 20MB까지 선택할 수 있어요.`);return}s(e),l(``),t?.(e)}},m=e=>{p(e.target.files?.[0])},h=e=>{e.preventDefault(),a.current+=1,d(!0)},g=e=>{e.preventDefault(),e.dataTransfer.dropEffect=`copy`},_=e=>{e.preventDefault(),a.current=Math.max(0,a.current-1),a.current===0&&d(!1)},v=e=>{e.preventDefault(),a.current=0,d(!1),p(e.dataTransfer.files?.[0])},y=()=>{s(null),l(``),i.current&&(i.current.value=``),t?.(null)},b=()=>{if(e){e();return}r(Lr.home)},ee=()=>{if(o){if(n){n(o);return}r(Lr.ocrProgress)}},S=Ur(o?.name??``)===`pdf`;return(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(`style`,{children:Rr}),(0,A.jsxs)(Zn,{className:`fu-page`,deviceClassName:`fu-device`,children:[(0,A.jsx)(Gn,{title:`파일 업로드`,leftIcon:`close`,onLeftClick:b}),(0,A.jsxs)(`main`,{className:`fu-content`,"aria-label":`파일 업로드`,children:[(0,A.jsx)(`input`,{ref:i,className:`fu-file-input`,type:`file`,accept:`.pdf,.jpg,.jpeg,.png,application/pdf,image/jpeg,image/png`,tabIndex:-1,"aria-hidden":`true`,onChange:m}),(0,A.jsxs)(`button`,{type:`button`,className:`fu-upload-zone ${u?`is-dragging`:``}`.trim(),"aria-describedby":c?`file-upload-error`:void 0,onClick:f,onDragEnter:h,onDragOver:g,onDragLeave:_,onDrop:v,children:[(0,A.jsx)(`span`,{className:`fu-upload-icon-box`,children:(0,A.jsx)(zr,{})}),(0,A.jsx)(`span`,{className:`fu-upload-title`,children:`여기를 눌러 파일을 선택하세요`}),(0,A.jsx)(`span`,{className:`fu-upload-description`,children:`PDF, JPG, PNG · 최대 20MB`}),(0,A.jsx)(`span`,{className:`fu-select-button`,children:`파일 선택하기`})]}),c?(0,A.jsx)(`p`,{id:`file-upload-error`,className:`fu-error`,role:`alert`,children:c}):null,(0,A.jsxs)(`section`,{className:`fu-file-section`,"aria-labelledby":`selected-file-title`,children:[(0,A.jsx)(`h2`,{id:`selected-file-title`,className:`fu-section-label`,children:`선택된 파일`}),o?(0,A.jsxs)(`article`,{className:`fu-file-card`,children:[(0,A.jsx)(`span`,{className:`fu-file-icon-box ${S?``:`is-image`}`.trim(),children:S?(0,A.jsx)(Br,{}):(0,A.jsx)(Vr,{})}),(0,A.jsxs)(`div`,{className:`fu-file-info`,children:[(0,A.jsx)(`div`,{className:`fu-file-name`,title:o.name,children:o.name}),(0,A.jsx)(`div`,{className:`fu-file-size`,children:Gr(o.size)})]}),(0,A.jsx)(`button`,{type:`button`,className:`fu-remove-file`,"aria-label":`${o.name} 선택 취소`,onClick:y,children:(0,A.jsx)(Hr,{})})]}):(0,A.jsx)(`div`,{className:`fu-empty-file`,children:`선택된 파일이 없습니다.`})]})]}),(0,A.jsx)(`footer`,{className:`fu-footer`,children:(0,A.jsx)(`button`,{type:`button`,className:`fu-analyze-button`,disabled:!o,onClick:ee,children:`분석 시작하기`})})]})]})}var qr=`/screen/10`,Jr=[{width:48,height:9},{width:84,height:7,topGap:8},{width:93,height:7},{width:68,height:7},{width:86,height:7,topGap:7},{width:73,height:7},{width:90,height:7},{width:57,height:7},{width:81,height:7,topGap:7},{width:94,height:7},{width:64,height:7},{width:85,height:7,topGap:7},{width:71,height:7},{width:43,height:7}],Yr={preparing:{label:`이미지 준비`,title:`계약서를 준비하고 있어요`,description:(0,A.jsxs)(A.Fragment,{children:[`선명한 글자 인식을 위해`,(0,A.jsx)(`br`,{}),`이미지를 정돈하고 있어요`]})},recognizing:{label:`텍스트 인식`,title:`글자를 읽고 있어요`,description:(0,A.jsxs)(A.Fragment,{children:[`계약서 이미지를 텍스트로`,(0,A.jsx)(`br`,{}),`변환하는 중이에요`]})},organizing:{label:`결과 정리`,title:`인식한 문장을 정리하고 있어요`,description:(0,A.jsxs)(A.Fragment,{children:[`문장과 조항의 순서를`,(0,A.jsx)(`br`,{}),`확인하는 중이에요`]})},complete:{label:`변환 완료`,title:`텍스트 변환을 마쳤어요`,description:(0,A.jsxs)(A.Fragment,{children:[`인식된 계약서를 검토할`,(0,A.jsx)(`br`,{}),`준비가 완료됐어요`]})}},Xr=`
  .op-page,
  .op-page * {
    box-sizing: border-box;
  }
...
`;function Zr(e){return Math.min(100,Math.max(0,Math.round(e)))}function Qr(e,t){return t&&Yr[t]?Yr[t]:e>=100?Yr.complete:e>=86?Yr.organizing:e>=12?Yr.recognizing:Yr.preparing}function $r({recognized:e=!1}){return(0,A.jsx)(`div`,{className:`op-document-lines ${e?`is-recognized`:`is-pending`}`,children:Jr.map((e,t)=>(0,A.jsx)(`span`,{className:`op-document-line`,style:{width:`${e.width}%`,height:`${e.height}px`,marginTop:e.topGap?`${e.topGap}px`:void 0}},`${e.width}-${t}`))})}function ei({progress:e,stage:t,demoTarget:n=100,onComplete:r}){let i=O(),[a,o]=(0,x.useState)(0),s=(0,x.useRef)(!1),c=Number.isFinite(e),l=Zr(c?e:a),u=Qr(l,t);return(0,x.useEffect)(()=>{if(c)return;let e=Zr(n),t,r,i=n=>{r??=n;let a=Math.min((n-r)/4800,1),s=1-(1-a)**3;o(Math.round(e*s)),a<1&&(t=window.requestAnimationFrame(i))};return t=window.requestAnimationFrame(i),()=>window.cancelAnimationFrame(t)},[n,c]),(0,x.useEffect)(()=>{if(l<100){s.current=!1;return}if(s.current)return;let e=window.setTimeout(()=>{if(!s.current){if(s.current=!0,r){r();return}i(qr)}},700);return()=>window.clearTimeout(e)},[l,i,r]),(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(`style`,{children:Xr}),(0,A.jsx)(Zn,{className:`op-page`,deviceClassName:`op-device`,children:(0,A.jsxs)(`main`,{className:`op-content`,"aria-label":`OCR 진행`,children:[(0,A.jsxs)(`div`,{className:`op-document`,"aria-hidden":`true`,children:[(0,A.jsx)($r,{}),(0,A.jsx)(`div`,{className:`op-recognition-layer`,children:(0,A.jsx)($r,{recognized:!0})}),(0,A.jsx)(`div`,{className:`op-scan-beam`})]}),(0,A.jsxs)(`div`,{className:`op-status-copy`,role:`status`,"aria-live":`polite`,children:[(0,A.jsxs)(`div`,{className:`op-stage-badge`,children:[(0,A.jsx)(`span`,{className:`op-stage-dot`}),(0,A.jsx)(`span`,{children:u.label})]}),(0,A.jsx)(`h1`,{className:`op-title`,children:u.title}),(0,A.jsx)(`p`,{className:`op-description`,children:u.description})]}),(0,A.jsxs)(`div`,{className:`op-progress-wrap`,role:`progressbar`,"aria-label":`계약서 OCR 진행률`,"aria-valuemin":`0`,"aria-valuemax":`100`,"aria-valuenow":l,"aria-valuetext":`${u.label}, ${l}%`,children:[(0,A.jsxs)(`div`,{className:`op-progress-meta`,children:[(0,A.jsx)(`span`,{className:`op-progress-label`,children:`전체 진행률`}),(0,A.jsxs)(`span`,{className:`op-progress-value`,children:[l,`%`]})]}),(0,A.jsx)(`div`,{className:`op-progress-track`,children:(0,A.jsx)(`div`,{className:`op-progress-fill ${l>=100?`is-complete`:``}`.trim(),style:{width:`${l}%`}})})]})]})})]})}var ti={ocrProgress:`/screen/9`,aiAnalysis:`/screen/11`},ni={companyName:`(주)모카커피`,startDate:`2026년 08월 01일`,hourlyWage:`9,860원`,contractText:`제3조(근로시간) 근로자의 근무시간은 09:00~18:00로 한다. 회사의 필요에 따라 근로자는 추가 수당 없이 연장 근무를 할 수 있다.
제4조(임금) 시급 9,860원을 지급하며 주휴수당은 별도 지급하지 않는다.`},ri=`
  .or-page,
  .or-page * {
    box-sizing: border-box;
  }
...
`;function ii(){return(0,A.jsxs)(`svg`,{width:`21`,height:`21`,viewBox:`0 0 24 24`,"aria-hidden":`true`,children:[(0,A.jsx)(`circle`,{cx:`12`,cy:`12`,r:`9.25`,fill:`none`,stroke:`currentColor`,strokeWidth:`1.8`}),(0,A.jsx)(`path`,{d:`M12 10.5v5`,fill:`none`,stroke:`currentColor`,strokeLinecap:`round`,strokeWidth:`1.9`}),(0,A.jsx)(`circle`,{cx:`12`,cy:`7.7`,r:`1.05`,fill:`currentColor`})]})}function ai(e){return Object.fromEntries(Object.entries(ni).map(([t,n])=>[t,e?.[t]==null?n:String(e[t])]))}function oi({initialValues:e,onBack:t,onAnalyze:n}){let r=O(),[i,a]=(0,x.useState)(()=>ai(e)),o=e=>{let{name:t,value:n}=e.target;a(e=>({...e,[t]:n}))},s=()=>{if(t){t();return}r(ti.ocrProgress)},c=e=>{e.preventDefault();let t=Object.fromEntries(Object.entries(i).map(([e,t])=>[e,t.trim()]));if(n){n(t);return}r(ti.aiAnalysis,{state:{reviewedContract:t}})},l=Object.values(i).every(e=>e.trim().length>0);return(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(`style`,{children:ri}),(0,A.jsxs)(Zn,{className:`or-page`,deviceClassName:`or-device`,children:[(0,A.jsx)(Gn,{title:`인식된 내용 확인`,leftIcon:`arrow_back`,onLeftClick:s}),(0,A.jsxs)(`form`,{className:`or-form-shell`,onSubmit:c,children:[(0,A.jsxs)(`main`,{className:`or-content`,"aria-label":`OCR 인식 내용 검토`,"aria-describedby":`ocr-review-guidance`,children:[(0,A.jsxs)(`aside`,{id:`ocr-review-guidance`,className:`or-guidance`,children:[(0,A.jsx)(`span`,{className:`or-guidance-icon`,children:(0,A.jsx)(ii,{})}),(0,A.jsx)(`p`,{className:`or-guidance-copy`,children:`틀리게 인식된 부분이 있다면 직접 고쳐주세요. 정확할수록 분석이 정확해져요.`})]}),(0,A.jsxs)(`div`,{className:`or-fields`,children:[(0,A.jsxs)(`label`,{className:`or-field`,htmlFor:`ocr-company-name`,children:[(0,A.jsx)(`span`,{className:`or-label`,children:`회사명`}),(0,A.jsx)(`input`,{id:`ocr-company-name`,className:`or-input`,name:`companyName`,type:`text`,value:i.companyName,autoComplete:`organization`,onChange:o})]}),(0,A.jsxs)(`label`,{className:`or-field`,htmlFor:`ocr-start-date`,children:[(0,A.jsx)(`span`,{className:`or-label`,children:`근무 시작일`}),(0,A.jsx)(`input`,{id:`ocr-start-date`,className:`or-input`,name:`startDate`,type:`text`,value:i.startDate,autoComplete:`off`,onChange:o})]}),(0,A.jsxs)(`label`,{className:`or-field`,htmlFor:`ocr-hourly-wage`,children:[(0,A.jsx)(`span`,{className:`or-label`,children:`시급`}),(0,A.jsx)(`input`,{id:`ocr-hourly-wage`,className:`or-input`,name:`hourlyWage`,type:`text`,inputMode:`decimal`,value:i.hourlyWage,autoComplete:`off`,onChange:o})]}),(0,A.jsxs)(`label`,{className:`or-field`,htmlFor:`ocr-contract-text`,children:[(0,A.jsx)(`span`,{className:`or-label`,children:`계약서 전문`}),(0,A.jsx)(`textarea`,{id:`ocr-contract-text`,className:`or-textarea`,name:`contractText`,value:i.contractText,spellCheck:`false`,onChange:o})]})]})]}),(0,A.jsx)(`footer`,{className:`or-footer`,children:(0,A.jsx)(`button`,{type:`submit`,className:`or-analyze-button`,disabled:!l,children:`이대로 분석하기`})})]})]})]})}var si=`/screen/12`,ci=[{pendingLabel:`텍스트 인식`,activeLabel:`텍스트 인식 중...`,completeLabel:`텍스트 인식 완료`},{pendingLabel:`근로기준법 대조`,activeLabel:`근로기준법 대조 중...`,completeLabel:`근로기준법 대조 완료`},{pendingLabel:`독소조항 탐지`,activeLabel:`독소조항 탐지 중...`,completeLabel:`독소조항 탐지 완료`},{pendingLabel:`수정 제안 생성`,activeLabel:`수정 제안 생성 중...`,completeLabel:`수정 제안 생성 완료`}],li=[`제3조에서 무급 연장근로 조항을 발견했어요`,`제4조에서 주휴수당 미지급 조항을 발견했어요`],ui=`
  .aa-page,
  .aa-page * {
    box-sizing: border-box;
  }
...
`;function di(e){return Math.min(ci.length,Math.max(0,Math.floor(Number(e)||0)))}function fi(e,t){return e<t?`complete`:e===t&&t<ci.length?`active`:`pending`}function pi(e,t){return t===`complete`?e.completeLabel:t===`active`?e.activeLabel:e.pendingLabel}function mi({state:e}){let t={complete:`check_circle`,active:`progress_activity`,pending:`radio_button_unchecked`}[e];return(0,A.jsx)(`span`,{className:`msr aa-step-icon`,"aria-hidden":`true`,children:t})}function hi({currentStep:e,liveMessage:t,demoTarget:n=ci.length,onComplete:r}){let i=O(),[a,o]=(0,x.useState)(0),[s,c]=(0,x.useState)(-1),l=(0,x.useRef)(!1),u=Number.isFinite(e),d=di(u?e:a),f=ci[Math.min(d,ci.length-1)],p=d>=ci.length,m=d/ci.length*100,h=typeof t==`string`?t:!u&&s>=0?li[s]:``;(0,x.useEffect)(()=>{if(u)return;let e=di(n);if(o(0),c(-1),e===0)return;let t=[],r=(e,n)=>{t.push(window.setTimeout(e,n))};return e>=1&&r(()=>o(1),1100),e>=2&&(r(()=>o(2),2200),r(()=>c(0),2900),r(()=>c(1),3800)),e>=3&&r(()=>o(3),4700),e>=4&&r(()=>o(4),6e3),()=>t.forEach(e=>window.clearTimeout(e))},[n,u]),(0,x.useEffect)(()=>{if(!p){l.current=!1;return}if(l.current)return;let e=window.setTimeout(()=>{if(!l.current){if(l.current=!0,r){r();return}i(si)}},700);return()=>window.clearTimeout(e)},[p,i,r]);let g=p?`AI 계약서 분석이 완료되었습니다.`:f.activeLabel;return(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(`style`,{children:ui}),(0,A.jsx)(Zn,{className:`aa-page`,deviceClassName:`aa-device`,children:(0,A.jsx)(`main`,{className:`aa-content`,"aria-label":`AI 계약서 분석 진행`,"aria-busy":!p,children:(0,A.jsxs)(`section`,{className:`aa-analysis-panel`,"aria-labelledby":`ai-analysis-title`,children:[(0,A.jsxs)(`div`,{className:`aa-visual ${p?`is-complete`:``}`.trim(),"aria-hidden":`true`,children:[(0,A.jsxs)(`svg`,{className:`aa-progress-ring`,viewBox:`0 0 134 134`,children:[(0,A.jsx)(`circle`,{className:`aa-progress-track`,cx:`67`,cy:`67`,r:`63`}),(0,A.jsx)(`circle`,{className:`aa-progress-value`,cx:`67`,cy:`67`,r:`63`,pathLength:`100`,style:{strokeDashoffset:100-m}})]}),(0,A.jsx)(`div`,{className:`aa-visual-core`,children:(0,A.jsx)(`span`,{className:`aa-symbol-stack`,children:(0,A.jsx)(`span`,{className:`msr aa-brain-icon`,children:`neurology`})})})]}),(0,A.jsx)(`h1`,{id:`ai-analysis-title`,className:`aa-title`,children:p?(0,A.jsxs)(A.Fragment,{children:[`계약서 분석을`,(0,A.jsx)(`br`,{}),`모두 마쳤어요`]}):(0,A.jsxs)(A.Fragment,{children:[`AI가 계약서를`,(0,A.jsx)(`br`,{}),`꼼꼼히 살펴보고 있어요`]})}),h?(0,A.jsx)(`div`,{className:`aa-live-finding`,role:`status`,"aria-live":`polite`,children:(0,A.jsx)(`span`,{className:`aa-finding-text`,children:h})},h):null,(0,A.jsx)(`ol`,{className:`aa-steps`,children:ci.map((e,t)=>{let n=fi(t,d);return(0,A.jsxs)(`li`,{className:`aa-step is-${n}`,"aria-current":n===`active`?`step`:void 0,children:[(0,A.jsx)(mi,{state:n}),(0,A.jsx)(`span`,{className:`aa-step-label`,children:pi(e,n)})]},e.pendingLabel)})}),(0,A.jsx)(`p`,{className:`aa-sr-only`,role:`status`,"aria-live":`polite`,children:g})]})})})]})}var gi=[{key:`all`,label:`전체`},{key:`danger`,label:`위험`},{key:`caution`,label:`주의`},{key:`safe`,label:`안전`}],_i={danger:`위험 조항`,caution:`주의 조항`,safe:`안전 조항`},vi={clauses:[{id:`overtime-pay`,severity:`danger`,title:`연장근무 수당 미지급`,contractText:`근로자는 추가 수당 없이 연장 근무를 할 수 있다.`,description:`추가 수당을 지급하지 않는다는 문구가 법정 가산임금 기준과 충돌할 수 있어요.`,lawStandard:`연장근로에는 통상임금의 50% 이상을 가산해 지급해야 해요.`,reference:`근로기준법 제56조 위반 소지`,sourceUrl:`https://law.go.kr/LSW/lsLinkCommonInfo.do?chrClsCd=010202&lsJoLnkSeq=1025590209`},{id:`weekly-holiday`,severity:`danger`,title:`주휴수당 누락`,contractText:`주휴수당은 별도 지급하지 않는다.`,description:`근무 조건을 따지지 않고 주휴수당을 배제하는 문구는 위험할 수 있어요.`,lawStandard:`사용자는 근로자에게 1주에 평균 1회 이상의 유급휴일을 보장해야 해요.`,reference:`근로기준법 제55조 확인 필요`,sourceUrl:`https://www.law.go.kr/lsLinkCommonInfo.do?ancYnChk=&chrClsCd=010202&lsJoLnkSeq=1015677471`},{id:`unfair-dismissal`,severity:`danger`,title:`일방적 계약 해지 조건`,contractText:`회사는 필요할 경우 즉시 계약을 해지할 수 있다.`,description:`회사의 필요만으로 즉시 해지할 수 있다는 문구는 근로자에게 매우 불리해요.`,lawStandard:`사용자는 정당한 이유 없이 근로자를 해고하거나 징벌할 수 없어요.`,reference:`근로기준법 제23조 위반 소지`,sourceUrl:`https://www.law.go.kr/lsLinkCommonInfo.do?lsJoLnkSeq=1025589911`},{id:`excessive-damages`,severity:`caution`,title:`과도한 손해배상 조항`,contractText:`근로자의 귀책 사유 발생 시 월 급여의 3배를 배상한다.`,description:`실제 손해와 관계없이 배상액을 미리 정한 것으로 해석될 가능성이 있어요.`,lawStandard:`근로계약 불이행에 대한 위약금이나 손해배상액을 미리 정할 수 없어요.`,reference:`근로기준법 제20조 위반 소지`,sourceUrl:`https://law.go.kr/lsLinkCommonInfo.do?lsJoLnkSeq=1007689123`},{id:`unclear-duties`,severity:`caution`,title:`업무 범위가 불명확해요`,contractText:`근로자는 회사가 지정하는 기타 업무를 수행한다.`,description:`업무 범위가 지나치게 넓어 계약 후 예상하지 못한 업무가 추가될 수 있어요.`,lawStandard:`근로조건은 계약할 때 구체적으로 확인하고 서면으로 명확히 두는 것이 안전해요.`,reference:`근로기준법 제17조 및 업무 범위 확인 필요`,sourceUrl:`https://law.go.kr/lsLinkCommonInfo.do?chrClsCd=010202&lsJoLnkSeq=1014516221`},{id:`working-hours`,severity:`safe`,title:`근무시간이 명확해요`,contractText:`근로자의 근무시간은 09:00~18:00로 한다.`,description:`근무 시작과 종료 시간이 구체적으로 작성되어 있어 확인하기 쉬워요.`,lawStandard:`사용자는 근로계약을 체결할 때 소정근로시간을 명시해야 해요.`,reference:`근로기준법 제17조 기준 충족 가능`,sourceUrl:`https://law.go.kr/lsLinkCommonInfo.do?chrClsCd=010202&lsJoLnkSeq=1014516221`}]};function yi(){return(0,A.jsx)(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`,children:(0,A.jsx)(`path`,{d:`M19 12H5M11 18l-6-6 6-6`})})}function bi(){return(0,A.jsx)(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`,children:(0,A.jsx)(`path`,{d:`M12 3v12M8 7l4-4 4 4M6 11H5a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-6a2 2 0 0 0-2-2h-1`})})}function xi(){return(0,A.jsx)(`svg`,{viewBox:`0 0 24 24`,"aria-hidden":`true`,children:(0,A.jsx)(`path`,{d:`m6 6 12 12M18 6 6 18`})})}function Si({clause:e,activeFilter:t,isSelected:n,onSelect:r,children:i}){let a=t!==`all`&&t!==e.severity;return(0,A.jsx)(`mark`,{className:`rs-highlight is-${e.severity}${a?` is-muted`:``}${n?` is-selected`:``}`,role:`button`,tabIndex:a?-1:0,"aria-disabled":a,"aria-pressed":n,"aria-label":`${e.title}: ${i}`,onClick:()=>{a||r(e)},onKeyDown:t=>{a||t.key!==`Enter`&&t.key!==` `||(t.preventDefault(),r(e))},children:i})}function Ci({result:e,onBack:t,onShare:n,onClauseSelect:r,onViewSuggestions:i,onConsult:a}){let o=O(),s=(0,x.useRef)(null),[c,l]=(0,x.useState)(`all`),[u,d]=(0,x.useState)(null),[f,p]=(0,x.useState)(``),m=(0,x.useMemo)(()=>({...vi,...e,clauses:e?.clauses??vi.clauses}),[e]),h=(0,x.useMemo)(()=>Object.fromEntries(m.clauses.map(e=>[e.id,e])),[m.clauses]),g=(0,x.useMemo)(()=>{let e={all:m.clauses.length,danger:0,caution:0,safe:0};return m.clauses.forEach(({severity:t})=>{t in e&&(e[t]+=1)}),e},[m.clauses]),_=u?h[u]:null;(0,x.useEffect)(()=>()=>{s.current&&window.clearTimeout(s.current)},[]);let v=e=>{s.current&&window.clearTimeout(s.current),p(e),s.current=window.setTimeout(()=>p(``),2400)},y=()=>{if(t){t();return}o(`/screen/10`)},b=async()=>{if(n){n(m);return}let e={title:`계약서 분석 결과`,text:`위험 ${g.danger}건 · 주의 ${g.caution}건 · 안전 ${g.safe}건`};try{if(navigator.share){await navigator.share(e),v(`분석 결과를 공유했어요.`);return}await navigator.clipboard.writeText(e.text),v(`분석 결과를 복사했어요.`)}catch(e){e?.name!==`AbortError`&&v(`공유 기능을 사용할 수 없어요.`)}},ee=e=>{l(e),_&&e!==`all`&&_.severity!==e&&d(null)},S=e=>{d(e.id),r?.(e)},C=()=>{if(i){i(m);return}v(`수정 제안 기능은 다음 연결 단계에서 제공돼요.`)},te=()=>{if(a){a(m);return}v(`전문가 상담 기능은 다음 연결 단계에서 제공돼요.`)},ne=e=>({clause:h[e],activeFilter:c,isSelected:u===e,onSelect:S});return(0,A.jsxs)(Zn,{className:`rs-page`,deviceClassName:`rs-device`,children:[(0,A.jsx)(`style`,{children:`
        .rs-page {
          --rs-ink: #18181a;
          --rs-subtle: #8b8b92;
          --rs-line: #e8e8ea;
      ...
      `}),(0,A.jsxs)(`header`,{className:`rs-header`,children:[(0,A.jsx)(`button`,{className:`rs-icon-button`,type:`button`,"aria-label":`이전 화면`,onClick:y,children:(0,A.jsx)(yi,{})}),(0,A.jsx)(`h1`,{className:`rs-header-title`,children:`분석 결과`}),(0,A.jsx)(`button`,{className:`rs-icon-button`,type:`button`,"aria-label":`분석 결과 공유`,onClick:b,children:(0,A.jsx)(bi,{})})]}),(0,A.jsxs)(`main`,{className:`rs-content`,"aria-label":`계약서 분석 결과 상세`,children:[(0,A.jsx)(`div`,{className:`rs-filter-list`,role:`group`,"aria-label":`위험도별 조항 필터`,children:gi.map(e=>(0,A.jsxs)(`button`,{className:`rs-filter is-${e.key}${c===e.key?` is-active`:``}`,type:`button`,"aria-pressed":c===e.key,onClick:()=>ee(e.key),children:[(0,A.jsx)(`span`,{children:e.label}),(0,A.jsx)(`span`,{children:g[e.key]})]},e.key))}),(0,A.jsxs)(`section`,{"aria-labelledby":`contract-highlight-title`,children:[(0,A.jsx)(`h2`,{className:`rs-section-title`,id:`contract-highlight-title`,children:`형광펜으로 표시된 계약서`}),(0,A.jsxs)(`article`,{className:`rs-contract-card`,children:[(0,A.jsxs)(`p`,{children:[`제3조(근로시간)`,` `,(0,A.jsx)(Si,{...ne(`working-hours`),children:`근로자의 근무시간은 09:00~18:00로 한다.`})]}),(0,A.jsxs)(`p`,{children:[`회사의 필요에 따라`,` `,(0,A.jsx)(Si,{...ne(`overtime-pay`),children:`근로자는 추가 수당 없이 연장 근무를 할 수 있다.`})]}),(0,A.jsxs)(`p`,{children:[`제4조(임금) 시급 9,860원을 지급하며`,` `,(0,A.jsx)(Si,{...ne(`weekly-holiday`),children:`주휴수당은 별도 지급하지 않는다.`})]}),(0,A.jsxs)(`p`,{children:[`제5조(업무)`,` `,(0,A.jsx)(Si,{...ne(`unclear-duties`),children:`근로자는 회사가 지정하는 기타 업무를 수행한다.`})]}),(0,A.jsxs)(`p`,{children:[`제6조(계약해지)`,` `,(0,A.jsx)(Si,{...ne(`unfair-dismissal`),children:`회사는 필요할 경우 즉시 계약을 해지할 수 있다.`})]}),(0,A.jsxs)(`p`,{children:[`제7조(손해배상)`,` `,(0,A.jsx)(Si,{...ne(`excessive-damages`),children:`근로자의 귀책 사유 발생 시 월 급여의 3배를 배상한다.`})]})]}),(0,A.jsxs)(`p`,{className:`rs-tap-hint`,children:[(0,A.jsx)(`span`,{className:`rs-tap-dot`,"aria-hidden":`true`,children:`i`}),`형광펜 표시를 누르면 법 기준과 비교할 수 있어요`]})]})]}),(0,A.jsxs)(`footer`,{className:`rs-footer`,children:[(0,A.jsx)(`button`,{className:`rs-action`,type:`button`,onClick:C,children:`수정 제안 보기`}),(0,A.jsx)(`button`,{className:`rs-action is-primary`,type:`button`,onClick:te,children:`전문가 상담`})]}),_?(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(`button`,{className:`rs-sheet-backdrop`,type:`button`,"aria-label":`발견된 조항 닫기`,onClick:()=>d(null)}),(0,A.jsxs)(`aside`,{className:`rs-explanation is-${_.severity}`,role:`dialog`,"aria-modal":`true`,"aria-labelledby":`selected-clause-title`,children:[(0,A.jsx)(`div`,{className:`rs-sheet-handle`,"aria-hidden":`true`}),(0,A.jsxs)(`div`,{className:`rs-sheet-header`,children:[(0,A.jsx)(`h2`,{className:`rs-sheet-heading`,children:`발견된 조항`}),(0,A.jsx)(`button`,{className:`rs-explanation-close`,type:`button`,"aria-label":`발견된 조항 닫기`,onClick:()=>d(null),children:(0,A.jsx)(xi,{})})]}),(0,A.jsxs)(`span`,{className:`rs-severity-label`,children:[(0,A.jsx)(`span`,{className:`rs-severity-dot`,"aria-hidden":`true`}),_i[_.severity]]}),(0,A.jsx)(`h3`,{className:`rs-explanation-title`,id:`selected-clause-title`,children:_.title}),(0,A.jsxs)(`div`,{className:`rs-comparison`,children:[(0,A.jsxs)(`div`,{className:`rs-comparison-card`,children:[(0,A.jsx)(`span`,{className:`rs-comparison-label`,children:`계약서 내용`}),(0,A.jsxs)(`p`,{className:`rs-comparison-text`,children:[`“`,_.contractText,`”`]})]}),(0,A.jsx)(`span`,{className:`rs-compare-arrow`,"aria-hidden":`true`,children:`↓`}),(0,A.jsxs)(`div`,{className:`rs-comparison-card is-law`,children:[(0,A.jsx)(`span`,{className:`rs-comparison-label`,children:`근로기준법 기준`}),(0,A.jsx)(`p`,{className:`rs-comparison-text`,children:_.lawStandard})]})]}),(0,A.jsx)(`p`,{className:`rs-analysis-note`,children:_.description}),(0,A.jsx)(`a`,{className:`rs-explanation-reference`,href:_.sourceUrl,target:`_blank`,rel:`noreferrer`,children:(0,A.jsx)(`span`,{children:_.reference})}),(0,A.jsx)(`p`,{className:`rs-legal-notice`,children:`AI 분석은 계약서 검토를 돕기 위한 참고 정보이며, 구체적인 법률 판단은 전문가 상담이 필요할 수 있어요.`})]})]}):null,f?(0,A.jsx)(`div`,{className:`rs-toast`,role:`status`,"aria-live":`polite`,children:f}):null]})}var wi=({count:e=0,label:t,isDanger:n=!1})=>(0,A.jsxs)(`div`,{style:{flex:1,textAlign:`center`},children:[(0,A.jsx)(`div`,{className:`f18 fw8`,style:{color:n?`var(--danger)`:`var(--ink)`},children:e}),(0,A.jsx)(`div`,{className:`f11 tc`,style:{marginTop:`6px`},children:t})]}),Ti=({icon:e,title:t,onClick:n,isLast:r=!1})=>(0,A.jsxs)(`div`,{onClick:n,style:{display:`flex`,alignItems:`center`,justifyContent:`space-between`,padding:`18px 0`,cursor:`pointer`,borderBottom:r?`none`:`1px solid var(--line)`},children:[(0,A.jsxs)(`div`,{className:`row gap12`,children:[(0,A.jsx)(`span`,{className:`msr`,style:{color:`var(--ink)`},children:e}),(0,A.jsx)(`span`,{className:`f15 fw7`,style:{color:`var(--ink)`},children:t})]}),(0,A.jsx)(`span`,{className:`msr`,style:{color:`var(--ink-3)`,fontSize:`20px`},children:`chevron_right`})]}),Ei=({userData:e})=>{let t=O(),[n,r]=(0,x.useState)(!1),i=e||{name:`지민`,email:`jimin_park@email.com`,stats:{total:4,danger:3,consult:1}},a=(0,x.useMemo)(()=>[{id:`work-info`,path:`/screen/19/work-info`,icon:`badge`,title:`내 근무 정보 관리`},{id:`alarm-set`,path:`/screen/19/alarm-set`,icon:`notifications`,title:`알림 설정`},{id:`privacy`,path:`/screen/19/privacy`,icon:`lock`,title:`개인정보 처리방침`}],[]),o=(0,x.useMemo)(()=>[{id:`faq`,path:`/screen/19/faq`,icon:`help`,title:`자주 묻는 질문`},{id:`contact`,path:`/screen/19/contact`,icon:`mail`,title:`문의하기`}],[]);return(0,A.jsxs)(A.Fragment,{children:[(0,A.jsxs)(`div`,{className:`row gap12`,style:{padding:`8px 0 24px`},children:[(0,A.jsx)(`div`,{className:`avatar`,style:{width:`56px`,height:`56px`,background:`var(--yellow-soft)`,borderRadius:`50%`,display:`flex`,alignItems:`center`,justifyContent:`center`},children:(0,A.jsx)(`span`,{className:`msr`,style:{fontSize:`26px`},children:`person`})}),(0,A.jsxs)(`div`,{children:[(0,A.jsxs)(`div`,{className:`f18 fw8`,children:[i.name,` 님`]}),(0,A.jsx)(`div`,{className:`f12 tc`,style:{marginTop:`6px`},children:i.email})]})]}),(0,A.jsxs)(`div`,{className:`card row`,style:{padding:`20px 16px`,marginBottom:`32px`},children:[(0,A.jsx)(wi,{count:i.stats?.total,label:`분석 건수`}),(0,A.jsx)(`div`,{style:{width:`1px`,height:`32px`,background:`var(--line)`}}),(0,A.jsx)(wi,{count:i.stats?.danger,label:`발견된 위험조항`,isDanger:!0}),(0,A.jsx)(`div`,{style:{width:`1px`,height:`32px`,background:`var(--line)`}}),(0,A.jsx)(wi,{count:i.stats?.consult,label:`상담 이력`})]}),(0,A.jsxs)(`div`,{style:{marginBottom:`28px`},children:[(0,A.jsx)(`div`,{className:`f13 fw7 tc2`,style:{marginBottom:`10px`,marginLeft:`4px`},children:`설정`}),(0,A.jsx)(`div`,{className:`card`,style:{padding:`0 20px`},children:a.map((e,n)=>(0,A.jsx)(Ti,{icon:e.icon,title:e.title,onClick:()=>t(e.path),isLast:n===a.length-1},e.id))})]}),(0,A.jsxs)(`div`,{style:{marginBottom:`40px`},children:[(0,A.jsx)(`div`,{className:`f13 fw7 tc2`,style:{marginBottom:`10px`,marginLeft:`4px`},children:`지원`}),(0,A.jsx)(`div`,{className:`card`,style:{padding:`0 20px`},children:o.map((e,n)=>(0,A.jsx)(Ti,{icon:e.icon,title:e.title,onClick:()=>t(e.path),isLast:n===o.length-1},e.id))})]}),(0,A.jsx)(`div`,{style:{textAlign:`center`,paddingBottom:`40px`},children:(0,A.jsx)(`button`,{onClick:()=>r(!0),style:{background:`none`,border:`none`,color:`var(--danger)`,fontSize:`14px`,fontWeight:`700`,cursor:`pointer`,fontFamily:`inherit`},children:`로그아웃`})}),n&&(0,A.jsx)(`div`,{style:{position:`fixed`,top:0,left:0,right:0,bottom:0,background:`rgba(0,0,0,0.5)`,zIndex:1e3,display:`flex`,alignItems:`center`,justifyContent:`center`},children:(0,A.jsxs)(`div`,{className:`card`,style:{width:`80%`,maxWidth:`320px`,padding:`24px`,textAlign:`center`},children:[(0,A.jsx)(`span`,{className:`msr`,style:{color:`var(--caution)`,fontSize:`36px`,marginBottom:`12px`},children:`warning`}),(0,A.jsx)(`div`,{className:`f16 fw8`,style:{marginBottom:`8px`},children:`로그아웃 하시겠습니까?`}),(0,A.jsx)(`div`,{className:`f13 tc`,style:{marginBottom:`24px`},children:`서비스를 이용하려면 다시 로그인해야 해요.`}),(0,A.jsxs)(`div`,{className:`row gap12`,children:[(0,A.jsx)(`button`,{className:`btn btn-outline`,onClick:()=>r(!1),style:{flex:1},children:`취소`}),(0,A.jsx)(`button`,{className:`btn btn-primary`,onClick:()=>{alert(`로그아웃 되었습니다.`),r(!1)},style:{flex:1},children:`확인`})]})]})})]})};function Di({title:e,children:t}){let n=O();return(0,A.jsxs)(`div`,{className:`app-shell`,children:[(0,A.jsxs)(`div`,{className:`topnav`,children:[(0,A.jsx)(`div`,{className:`back`,onClick:()=>{n(`/screen/19`)},children:(0,A.jsx)(`span`,{className:`msr`,children:`arrow_back_ios_new`})}),(0,A.jsx)(`div`,{className:`title`,children:e}),(0,A.jsx)(`div`,{className:`placeholder`})]}),(0,A.jsx)(`div`,{className:`content-slot`,style:{paddingTop:`10px`},children:t})]})}function Oi({title:e,icon:t}){return(0,A.jsx)(Di,{title:e,children:(0,A.jsxs)(`div`,{style:{textAlign:`center`,padding:`60px 0`},children:[(0,A.jsx)(`span`,{className:`msr`,style:{fontSize:`56px`,color:`var(--ink-3)`},children:t}),(0,A.jsxs)(`h3`,{className:`f18 fw8`,style:{marginTop:`16px`},children:[e,` 화면`]}),(0,A.jsx)(`p`,{className:`f13 tc`,style:{marginTop:`8px`},children:`현재 상세 기능 개발 중입니다.`})]})})}function ki(){return(0,A.jsx)(Oi,{title:`내 근무 정보 관리`,icon:`badge`})}function Ai({isOn:e,onToggle:t,disabled:n}){return(0,A.jsx)(`div`,{onClick:()=>!n&&t(),style:{width:`46px`,height:`26px`,backgroundColor:e?`var(--safe)`:`var(--line)`,borderRadius:`13px`,position:`relative`,cursor:n?`not-allowed`:`pointer`,opacity:n?.5:1,transition:`background-color 0.2s ease-in-out`,flexShrink:0},children:(0,A.jsx)(`div`,{style:{width:`22px`,height:`22px`,backgroundColor:`var(--white)`,borderRadius:`50%`,position:`absolute`,top:`2px`,left:e?`22px`:`2px`,transition:`left 0.2s ease-in-out`,boxShadow:`0 2px 4px rgba(0,0,0,0.15)`}})})}function j({title:e,description:t,isOn:n,onToggle:r,disabled:i=!1,isLast:a=!1}){return(0,A.jsxs)(`div`,{className:`row between`,style:{padding:`16px 0`,borderBottom:a?`none`:`1px solid var(--line)`},children:[(0,A.jsxs)(`div`,{style:{paddingRight:`16px`,flex:1},children:[(0,A.jsx)(`div`,{className:`f15 fw7`,style:{color:i?`var(--ink-3)`:`var(--ink)`,marginBottom:`4px`},children:e}),(0,A.jsx)(`div`,{className:`f12 tc`,style:{lineHeight:`1.4`},children:t})]}),(0,A.jsx)(Ai,{isOn:n,onToggle:r,disabled:i})]})}function ji(){let[e,t]=(0,x.useState)({isAllEnabled:!0,analysisComplete:!0,riskDetected:!0,consultationAnswer:!0,laborLawUpdates:!0,marketingEvent:!1,nightTimeAd:!1}),n=()=>{let n=!e.isAllEnabled;t(e=>({isAllEnabled:n,analysisComplete:n?!0:e.analysisComplete,riskDetected:n?!0:e.riskDetected,consultationAnswer:n?!0:e.consultationAnswer,laborLawUpdates:n?!0:e.laborLawUpdates,marketingEvent:n?e.marketingEvent:!1,nightTimeAd:n?e.nightTimeAd:!1}))},r=n=>{if(!e.isAllEnabled){alert(`전체 알림 수신이 꺼져있습니다. 먼저 전체 알림을 켜주세요.`);return}let r=!e[n];n===`marketingEvent`&&!r?t(e=>({...e,[n]:r,nightTimeAd:!1})):n===`nightTimeAd`&&r&&!e.marketingEvent?alert(`야간 알림 수신을 위해서는 마케팅 혜택 알림에 먼저 동의해야 합니다.`):t(e=>({...e,[n]:r}))};return(0,A.jsx)(Di,{title:`알림 설정`,children:(0,A.jsxs)(`div`,{style:{paddingBottom:`20px`},children:[(0,A.jsx)(`div`,{style:{marginBottom:`28px`},children:(0,A.jsx)(`div`,{className:`card`,style:{padding:`0 20px`},children:(0,A.jsx)(j,{title:`전체 알림 수신`,description:`앱에서 보내는 모든 푸시 알림을 켜거나 끕니다.`,isOn:e.isAllEnabled,onToggle:n,isLast:!0})})}),(0,A.jsxs)(`div`,{style:{marginBottom:`28px`},children:[(0,A.jsx)(`div`,{className:`f13 fw7 tc2`,style:{marginBottom:`10px`,marginLeft:`4px`},children:`서비스 알림 (필수)`}),(0,A.jsxs)(`div`,{className:`card`,style:{padding:`0 20px`},children:[(0,A.jsx)(j,{title:`계약서 분석 완료 알림`,description:`등록하신 근로계약서의 AI 분석이 완료되면 알려드려요.`,isOn:e.analysisComplete,onToggle:()=>r(`analysisComplete`),disabled:!e.isAllEnabled}),(0,A.jsx)(j,{title:`위험 조항 발견 즉시 알림`,description:`치명적인 독소조항이 발견될 경우 즉시 알려드려요.`,isOn:e.riskDetected,onToggle:()=>r(`riskDetected`),disabled:!e.isAllEnabled}),(0,A.jsx)(j,{title:`전문가 상담 답변 알림`,description:`요청하신 노무 상담에 답변이 등록되면 알려드려요.`,isOn:e.consultationAnswer,onToggle:()=>r(`consultationAnswer`),disabled:!e.isAllEnabled,isLast:!0})]})]}),(0,A.jsxs)(`div`,{style:{marginBottom:`28px`},children:[(0,A.jsx)(`div`,{className:`f13 fw7 tc2`,style:{marginBottom:`10px`,marginLeft:`4px`},children:`정보 및 혜택 알림 (선택)`}),(0,A.jsxs)(`div`,{className:`card`,style:{padding:`0 20px`},children:[(0,A.jsx)(j,{title:`노동법 개정 및 정보 알림`,description:`최저임금 변경 등 근로자에게 유용한 정보를 보내드려요.`,isOn:e.laborLawUpdates,onToggle:()=>r(`laborLawUpdates`),disabled:!e.isAllEnabled}),(0,A.jsx)(j,{title:`마케팅 혜택 및 이벤트 알림`,description:`프로모션, 할인 혜택 등의 정보를 보내드려요.`,isOn:e.marketingEvent,onToggle:()=>r(`marketingEvent`),disabled:!e.isAllEnabled}),(0,A.jsx)(j,{title:`야간 알림 수신 동의`,description:`오후 9시 ~ 오전 8시 사이에도 혜택 알림을 받습니다.`,isOn:e.nightTimeAd,onToggle:()=>r(`nightTimeAd`),disabled:!e.isAllEnabled||!e.marketingEvent,isLast:!0})]})]})]})})}function Mi(){return(0,A.jsx)(Di,{title:`개인정보 처리방침`,children:(0,A.jsxs)(`div`,{style:{paddingBottom:`30px`},children:[(0,A.jsxs)(`div`,{className:`card`,style:{background:`var(--yellow-soft)`,border:`1px solid var(--yellow)`,marginBottom:`20px`,padding:`16px`},children:[(0,A.jsxs)(`div`,{className:`row gap8`,style:{marginBottom:`6px`},children:[(0,A.jsx)(`span`,{className:`msr`,style:{fontSize:`20px`,color:`var(--ink)`},children:`security`}),(0,A.jsx)(`div`,{className:`f15 fw8`,children:`형광펜 개인정보 보호 원칙`})]}),(0,A.jsx)(`p`,{className:`f12 tc2`,style:{lineHeight:`1.5`},children:`본 서비스는 사용자의 소중한 개인정보와 근로계약서 원본을 안전하게 보호하며, 관련 법령을 엄격히 준수합니다.`})]}),(0,A.jsxs)(`div`,{className:`card`,style:{marginBottom:`16px`},children:[(0,A.jsx)(`div`,{className:`f15 fw8`,style:{marginBottom:`8px`,color:`var(--ink)`},children:`1. 계약서 원본 이미지 즉시 삭제`}),(0,A.jsx)(`p`,{className:`f13 tc2`,style:{lineHeight:`1.6`},children:`사용자가 업로드하거나 촬영한 근로계약서 원본 이미지는 AI 분석이 완료되는 즉시 서버에서 영구 파기됩니다. 원본 파일은 어떠한 경우에도 장기 저장되거나 마케팅 목적으로 활용되지 않습니다.`})]}),(0,A.jsxs)(`div`,{className:`card`,style:{marginBottom:`16px`},children:[(0,A.jsx)(`div`,{className:`f15 fw8`,style:{marginBottom:`8px`,color:`var(--ink)`},children:`2. 최소한의 데이터 일시 처리`}),(0,A.jsx)(`p`,{className:`f13 tc2`,style:{lineHeight:`1.6`},children:`서비스 제공에 필수적인 최소한의 데이터(위험 조항 분석 결과, 계약 형태 등)만 일시적으로 처리하며, 목적 달성 즉시 안전한 방식으로 파기합니다. 불필요한 개인정보는 일체 수집하지 않습니다.`})]}),(0,A.jsxs)(`div`,{className:`card`,style:{marginBottom:`16px`},children:[(0,A.jsx)(`div`,{className:`f15 fw8`,style:{marginBottom:`8px`,color:`var(--ink)`},children:`3. 개인정보 수집·이용 동의 명시`}),(0,A.jsx)(`p`,{className:`f13 tc2`,style:{lineHeight:`1.6`},children:`회사는 회원 가입 및 서비스 이용 과정에서 이용자의 명확한 동의를 기반으로 필수적인 개인정보(계정 식별 정보 등)를 수집 및 이용하며, 동의 없이는 개인정보를 수집하지 않습니다.`})]}),(0,A.jsxs)(`div`,{className:`card`,style:{marginBottom:`16px`},children:[(0,A.jsx)(`div`,{className:`f15 fw8`,style:{marginBottom:`8px`,color:`var(--ink)`},children:`4. 관련 법령 준수 (전자상거래법 및 통신비밀보호법)`}),(0,A.jsxs)(`p`,{className:`f13 tc2`,style:{lineHeight:`1.6`,marginBottom:`12px`},children:[`- `,(0,A.jsx)(`strong`,{children:`전자상거래법 준수:`}),` 계약 또는 청약철회 등에 관한 기록 및 소비자 불만·분쟁 처리에 관한 기록은 전자상거래 등에서의 소비자보호에 관한 법률에 따라 안전하게 보관되며, 정해진 기간이 지나면 지체 없이 파기합니다.`]}),(0,A.jsxs)(`p`,{className:`f13 tc2`,style:{lineHeight:`1.6`},children:[`- `,(0,A.jsx)(`strong`,{children:`통신비밀보호법 준수:`}),` 서비스 이용 과정에서 생성되는 접속 로그 및 접속지 추적 자료 등은 통신비밀보호법에 의거하여 적법하게 관리되며, 법정 보존 기간 경과 후 안전하게 파기됩니다.`]})]}),(0,A.jsx)(`div`,{style:{textAlign:`center`,marginTop:`24px`},children:(0,A.jsx)(`span`,{className:`f11 tc`,children:`공고 일자: 2026년 8월 3일 / 시행 일자: 2026년 8월 3일`})})]})})}var Ni=[{q:`Q1. ‘형광펜’은 어떤 서비스인가요?`,a:`계약서 사진을 한 장 올리면, AI가 불리한 조항(독소조항)을 노란색 하이라이트로 칠해 한눈에 알아보도록 도와주는 서비스입니다. 복잡한 법률 용어를 알기 쉽게 설명해 주고, 상대방에게 보낼 수 있는 대응 문장까지 함께 제공합니다.`},{q:`Q2. 법률 자문이나 공식적인 법적 효력이 있는 서비스인가요?`,a:`아닙니다. ‘형광펜’은 전문적인 법률 자문이나 공식 법률 판단이 아니라, 계약서 읽기를 돕는 참고용 정보 및 가이드 서비스입니다. 판단의 주체는 사용자 본인이며, 정보의 비대칭을 좁혀 스스로 확인하고 질문할 수 있도록 돕는 도구입니다.`},{q:`Q3. 사용하기 위해 회원가입이 필수인가요?`,a:`아니요, 회원가입 절차 없이 앱 실행 후 바로 진입하여 이용하실 수 있습니다.`},{q:`Q4. 계약서 사진을 올리면 개인정보는 안전하게 보호되나요?`,a:`분석이 완료된 후 원본 이미지는 즉시 삭제됩니다. 서비스 제공에 필요한 최소한의 데이터만 일시 처리하며, 개인정보 처리방침에 따라 이름, 주소, 민감정보 보호를 철저히 준수합니다.`},{q:`Q5. AI가 계약서를 잘못 읽거나 오판할 수도 있나요?`,a:`분석 전 ‘이렇게 읽었습니다, 맞나요?’를 거치는 OCR 검증 단계를 거치며, 결과 화면에 피드백/신고 버튼이 상시 노출됩니다. 모든 조항을 단정하지 않고 위험도를 초록·노랑·빨강 3단계로 구분하여 신중하게 안내합니다.`},{q:`Q6. 서비스 이용 요금은 무료인가요?`,a:`MVP 단계에서는 전면 무료로 제공되며, 첫 경험을 완주할 수 있도록 지원합니다. 향후에는 긴 계약서 분석, 전문가 연결, 문서 변환 등 일부 기능에 대해 유료 모델이나 수익 구조가 도입될 예정입니다.`}];function Pi(){let[e,t]=(0,x.useState)(null),n=n=>{t(e===n?null:n)};return(0,A.jsx)(Di,{title:`자주 묻는 질문`,children:(0,A.jsxs)(`div`,{style:{paddingBottom:`30px`},children:[(0,A.jsxs)(`div`,{className:`card`,style:{background:`var(--yellow-soft)`,border:`1px solid var(--yellow)`,marginBottom:`20px`,padding:`16px`},children:[(0,A.jsxs)(`div`,{className:`row gap8`,style:{marginBottom:`6px`},children:[(0,A.jsx)(`span`,{className:`msr`,style:{fontSize:`20px`,color:`var(--ink)`},children:`help_outline`}),(0,A.jsx)(`div`,{className:`f15 fw8`,children:`궁금하신 점을 빠르게 해결해 드려요`})]}),(0,A.jsx)(`p`,{className:`f12 tc2`,style:{lineHeight:`1.5`},children:`서비스 이용과 관련된 주요 질문과 답변을 모아두었습니다. 추가 문의는 '문의하기'를 이용해 주세요.`})]}),(0,A.jsx)(`div`,{className:`card`,style:{padding:`0 20px`},children:Ni.map((t,r)=>{let i=e===r,a=r===Ni.length-1;return(0,A.jsxs)(`div`,{style:{borderBottom:a?`none`:`1px solid var(--line)`,padding:`18px 0`,cursor:`pointer`},onClick:()=>n(r),children:[(0,A.jsxs)(`div`,{className:`row between`,children:[(0,A.jsx)(`div`,{className:`f15 fw7`,style:{color:`var(--ink)`,paddingRight:`12px`,flex:1,lineHeight:`1.4`},children:t.q}),(0,A.jsx)(`span`,{className:`msr`,style:{fontSize:`20px`,color:`var(--ink-3)`,transform:i?`rotate(180deg)`:`rotate(0deg)`,transition:`transform 0.2s ease-in-out`,flexShrink:0},children:`expand_more`})]}),i&&(0,A.jsx)(`div`,{className:`f13 tc2`,style:{marginTop:`12px`,lineHeight:`1.6`,background:`var(--bg)`,padding:`14px`,borderRadius:`8px`},children:t.a})]},r)})})]})})}var Fi=[`분석 오류`,`기능 제안`,`이용 문의`,`기타`];function Ii({onReset:e}){return(0,A.jsxs)(`div`,{style:{textAlign:`center`,padding:`60px 20px`},children:[(0,A.jsx)(`div`,{style:{width:`64px`,height:`64px`,backgroundColor:`var(--yellow-soft)`,borderRadius:`50%`,display:`flex`,alignItems:`center`,justifyContent:`center`,margin:`0 auto 20px auto`},children:(0,A.jsx)(`span`,{className:`msr`,style:{fontSize:`36px`,color:`var(--yellow)`},children:`check_circle`})}),(0,A.jsx)(`h3`,{className:`f18 fw8`,style:{marginBottom:`8px`,color:`var(--ink)`},children:`문의가 성공적으로 접수되었습니다`}),(0,A.jsxs)(`p`,{className:`f13 tc2`,style:{lineHeight:`1.5`,marginBottom:`32px`},children:[`보내주신 소중한 의견과 문의 사항은 담당자 확인 후`,(0,A.jsx)(`br`,{}),`입력해주신 이메일로 빠르게 답변해 드리겠습니다.`]}),(0,A.jsx)(`button`,{onClick:e,style:{width:`100%`,padding:`16px`,backgroundColor:`var(--yellow)`,color:`var(--ink)`,border:`none`,borderRadius:`12px`,fontSize:`15px`,fontWeight:`700`,cursor:`pointer`},children:`추가 문의하기`})]})}function Li(){let[e,t]=(0,x.useState)(`분석 오류`),[n,r]=(0,x.useState)(``),[i,a]=(0,x.useState)(``),[o,s]=(0,x.useState)(!1),[c,l]=(0,x.useState)(!1);return c?(0,A.jsx)(Di,{title:`문의하기`,children:(0,A.jsx)(Ii,{onReset:()=>{l(!1),r(``),a(``),s(!1)}})}):(0,A.jsx)(Di,{title:`문의하기`,children:(0,A.jsxs)(`div`,{style:{paddingBottom:`30px`},children:[(0,A.jsxs)(`div`,{className:`card`,style:{background:`var(--yellow-soft)`,border:`1px solid var(--yellow)`,marginBottom:`20px`,padding:`16px`},children:[(0,A.jsxs)(`div`,{className:`row gap8`,style:{marginBottom:`6px`},children:[(0,A.jsx)(`span`,{className:`msr`,style:{fontSize:`20px`,color:`var(--ink)`},children:`support_agent`}),(0,A.jsx)(`div`,{className:`f15 fw8`,children:`궁금한 점이나 불편한 점이 있으신가요?`})]}),(0,A.jsx)(`p`,{className:`f12 tc2`,style:{lineHeight:`1.5`},children:`근로계약서 분석 오류나 개선 제안 등 남겨주시면 성심껏 답변해 드리겠습니다.`})]}),(0,A.jsxs)(`form`,{onSubmit:e=>{if(e.preventDefault(),!n.trim()){alert(`답변받으실 이메일 주소를 입력해주세요.`);return}if(!i.trim()){alert(`문의 내용을 입력해주세요.`);return}if(!o){alert(`개인정보 수집 및 이용에 동의해주세요.`);return}l(!0)},children:[(0,A.jsxs)(`div`,{className:`card`,style:{marginBottom:`16px`,padding:`20px`},children:[(0,A.jsx)(`div`,{className:`f14 fw7`,style:{marginBottom:`12px`,color:`var(--ink)`},children:`문의 유형`}),(0,A.jsx)(`div`,{style:{display:`flex`,gap:`8px`,flexWrap:`wrap`},children:Fi.map(n=>(0,A.jsx)(`button`,{type:`button`,onClick:()=>t(n),style:{padding:`8px 14px`,borderRadius:`20px`,border:e===n?`1px solid var(--ink)`:`1px solid var(--line)`,backgroundColor:e===n?`var(--ink)`:`var(--white)`,color:e===n?`var(--white)`:`var(--ink-2)`,fontSize:`13px`,fontWeight:`600`,cursor:`pointer`,transition:`all 0.2s ease`},children:n},n))})]}),(0,A.jsxs)(`div`,{className:`card`,style:{marginBottom:`16px`,padding:`20px`},children:[(0,A.jsx)(`div`,{className:`f14 fw7`,style:{marginBottom:`8px`,color:`var(--ink)`},children:`답변 받을 이메일`}),(0,A.jsx)(`input`,{type:`email`,value:n,onChange:e=>r(e.target.value),placeholder:`example@email.com`,style:{width:`100%`,padding:`12px 14px`,borderRadius:`8px`,border:`1px solid var(--line)`,backgroundColor:`var(--bg)`,fontSize:`14px`,color:`var(--ink)`,outline:`none`}})]}),(0,A.jsxs)(`div`,{className:`card`,style:{marginBottom:`16px`,padding:`20px`},children:[(0,A.jsx)(`div`,{className:`f14 fw7`,style:{marginBottom:`8px`,color:`var(--ink)`},children:`문의 내용`}),(0,A.jsx)(`textarea`,{value:i,onChange:e=>a(e.target.value),placeholder:`불편하신 사항이나 제안 내용을 자세히 적어주세요.`,rows:5,style:{width:`100%`,padding:`12px 14px`,borderRadius:`8px`,border:`1px solid var(--line)`,backgroundColor:`var(--bg)`,fontSize:`14px`,color:`var(--ink)`,outline:`none`,resize:`none`,fontFamily:`inherit`}})]}),(0,A.jsx)(`div`,{className:`card`,style:{marginBottom:`24px`,padding:`16px 20px`},children:(0,A.jsxs)(`label`,{style:{display:`flex`,alignItems:`center`,gap:`10px`,cursor:`pointer`},children:[(0,A.jsx)(`input`,{type:`checkbox`,checked:o,onChange:e=>s(e.target.checked),style:{width:`18px`,height:`18px`,accentColor:`var(--yellow)`}}),(0,A.jsx)(`span`,{className:`f13 tc2`,style:{lineHeight:`1.4`},children:`[필수] 문의 처리를 위한 개인정보 수집 및 이용에 동의합니다.`})]})}),(0,A.jsx)(`button`,{type:`submit`,style:{width:`100%`,padding:`16px`,backgroundColor:`var(--yellow)`,color:`var(--ink)`,border:`none`,borderRadius:`12px`,fontSize:`15px`,fontWeight:`700`,cursor:`pointer`,boxShadow:`0 4px 12px rgba(255, 214, 0, 0.3)`},children:`문의하기 제출`})]})]})})}var Ri={width:`100%`,padding:`12px 14px`,borderRadius:`8px`,border:`1px solid var(--line)`,backgroundColor:`var(--bg)`,fontSize:`14px`,color:`var(--ink)`,outline:`none`};function zi(){let[e,t]=(0,x.useState)(`지민`),[n,r]=(0,x.useState)(`jimin_park@email.com`),[i,a]=(0,x.useState)(``),[o,s]=(0,x.useState)(``),[c,l]=(0,x.useState)(``);return(0,A.jsx)(Di,{title:`마이페이지 설정`,children:(0,A.jsxs)(`div`,{style:{paddingBottom:`40px`},children:[(0,A.jsxs)(`div`,{style:{marginBottom:`28px`},children:[(0,A.jsx)(`div`,{className:`f13 fw7 tc2`,style:{marginBottom:`10px`,marginLeft:`4px`},children:`기본 정보 관리`}),(0,A.jsx)(`div`,{className:`card`,style:{padding:`20px`},children:(0,A.jsxs)(`form`,{onSubmit:t=>{if(t.preventDefault(),!e.trim()){alert(`이름을 입력해주세요.`);return}if(!n.trim()){alert(`이메일을 입력해주세요.`);return}alert(`회원 정보가 성공적으로 수정되었습니다.`)},children:[(0,A.jsxs)(`div`,{style:{marginBottom:`16px`},children:[(0,A.jsx)(`div`,{className:`f14 fw7`,style:{marginBottom:`8px`,color:`var(--ink)`},children:`이름`}),(0,A.jsx)(`input`,{type:`text`,value:e,onChange:e=>t(e.target.value),style:Ri})]}),(0,A.jsxs)(`div`,{style:{marginBottom:`20px`},children:[(0,A.jsx)(`div`,{className:`f14 fw7`,style:{marginBottom:`8px`,color:`var(--ink)`},children:`이메일 (아이디)`}),(0,A.jsx)(`input`,{type:`email`,value:n,onChange:e=>r(e.target.value),style:Ri})]}),(0,A.jsx)(`button`,{type:`submit`,style:{width:`100%`,padding:`14px`,backgroundColor:`var(--yellow)`,color:`var(--ink)`,border:`none`,borderRadius:`10px`,fontSize:`14px`,fontWeight:`700`,cursor:`pointer`},children:`기본 정보 저장`})]})})]}),(0,A.jsxs)(`div`,{style:{marginBottom:`28px`},children:[(0,A.jsx)(`div`,{className:`f13 fw7 tc2`,style:{marginBottom:`10px`,marginLeft:`4px`},children:`비밀번호 변경`}),(0,A.jsx)(`div`,{className:`card`,style:{padding:`20px`},children:(0,A.jsxs)(`form`,{onSubmit:e=>{if(e.preventDefault(),!i){alert(`현재 비밀번호를 입력해주세요.`);return}if(!o){alert(`새 비밀번호를 입력해주세요.`);return}if(o!==c){alert(`새 비밀번호와 비밀번호 확인이 일치하지 않습니다.`);return}alert(`비밀번호가 성공적으로 변경되었습니다.`),a(``),s(``),l(``)},children:[(0,A.jsxs)(`div`,{style:{marginBottom:`16px`},children:[(0,A.jsx)(`div`,{className:`f14 fw7`,style:{marginBottom:`8px`,color:`var(--ink)`},children:`현재 비밀번호`}),(0,A.jsx)(`input`,{type:`password`,value:i,onChange:e=>a(e.target.value),placeholder:`현재 비밀번호를 입력하세요`,style:Ri})]}),(0,A.jsxs)(`div`,{style:{marginBottom:`16px`},children:[(0,A.jsx)(`div`,{className:`f14 fw7`,style:{marginBottom:`8px`,color:`var(--ink)`},children:`새 비밀번호`}),(0,A.jsx)(`input`,{type:`password`,value:o,onChange:e=>s(e.target.value),placeholder:`새 비밀번호를 입력하세요`,style:Ri})]}),(0,A.jsxs)(`div`,{style:{marginBottom:`20px`},children:[(0,A.jsx)(`div`,{className:`f14 fw7`,style:{marginBottom:`8px`,color:`var(--ink)`},children:`새 비밀번호 확인`}),(0,A.jsx)(`input`,{type:`password`,value:c,onChange:e=>l(e.target.value),placeholder:`새 비밀번호를 한번 더 입력하세요`,style:Ri})]}),(0,A.jsx)(`button`,{type:`submit`,style:{width:`100%`,padding:`14px`,backgroundColor:`var(--ink)`,color:`var(--white)`,border:`none`,borderRadius:`10px`,fontSize:`14px`,fontWeight:`700`,cursor:`pointer`},children:`비밀번호 변경`})]})})]}),(0,A.jsx)(`div`,{style:{textAlign:`center`,marginTop:`20px`},children:(0,A.jsx)(`button`,{onClick:()=>alert(`회원 탈퇴 기능은 준비 중입니다.`),style:{background:`none`,border:`none`,color:`var(--ink-3)`,fontSize:`13px`,cursor:`pointer`,textDecoration:`underline`,fontFamily:`inherit`},children:`형광펜 회원 탈퇴하기`})})]})})}function Bi(){return(0,A.jsx)(Wt,{children:(0,A.jsxs)(k,{element:(0,A.jsx)(sr,{}),children:[(0,A.jsx)(k,{path:`/`,element:null}),(0,A.jsx)(k,{path:`/screen/7`,element:(0,A.jsx)(mr,{})}),(0,A.jsx)(k,{path:`/screen/8`,element:(0,A.jsx)(Kr,{})}),(0,A.jsx)(k,{path:`/screen/9`,element:(0,A.jsx)(ei,{})}),(0,A.jsx)(k,{path:`/screen/10`,element:(0,A.jsx)(oi,{})}),(0,A.jsx)(k,{path:`/screen/11`,element:(0,A.jsx)(hi,{})}),(0,A.jsx)(k,{path:`/screen/12`,element:(0,A.jsx)(Ci,{})}),(0,A.jsx)(k,{path:`/screen/16`,element:(0,A.jsx)(vr,{})}),(0,A.jsx)(k,{path:`/screen/17`,element:(0,A.jsx)(wr,{})}),(0,A.jsx)(k,{path:`/screen/18`,element:(0,A.jsx)(Pr,{})}),(0,A.jsx)(k,{path:`/screen/19`,element:(0,A.jsx)(Ei,{})}),(0,A.jsx)(k,{path:`/screen/19/work-info`,element:(0,A.jsx)(ki,{})}),(0,A.jsx)(k,{path:`/screen/19/alarm-set`,element:(0,A.jsx)(ji,{})}),(0,A.jsx)(k,{path:`/screen/19/privacy`,element:(0,A.jsx)(Mi,{})}),(0,A.jsx)(k,{path:`/screen/19/faq`,element:(0,A.jsx)(Pi,{})}),(0,A.jsx)(k,{path:`/screen/19/contact`,element:(0,A.jsx)(Li,{})}),(0,A.jsx)(k,{path:`/screen/19/account-settings`,element:(0,A.jsx)(zi,{})})]})})}(0,Un.createRoot)(document.getElementById(`root`)).render((0,A.jsx)(x.StrictMode,{children:(0,A.jsx)(kn,{children:(0,A.jsx)(Bi,{})})}));